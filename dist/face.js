...
var face = function face(key, host) {
    ...
    var faceList = {
         ...
         * @return {Promise}                                - Promise resolving with the resulting JSON
         */
        get: function get(faceListId, options) {
            return new _Promise(function (resolve, reject) {
                request({
                    uri: host + rootPath + faceListPath + '/' + faceListId,
                    headers: { 'Ocp-Apim-Subscription-Key': key },
    ...
    var personGroup = {
         ...
         * @return {Promise}                    - Promise resolving with the resulting JSON
         */
        create: function create(personGroupId, name, userData, recognitionModel) {
            return new _Promise(function (resolve, reject) {
                request.put({
         ...
         * @return {Promise}                                - Promise resolving with the resulting JSON
         */
        get: function get(personGroupId, options) {
            return new _Promise(function (resolve, reject) {
                request({
                    uri: host + rootPath + personGroupPath + '/' + personGroupId,
                    headers: { 'Ocp-Apim-Subscription-Key': key },
    ...
    var largePersonGroup = {
         ...
         * @return {Promise}                    - Promise resolving with the resulting JSON
         */
        create: function create(largePersonGroupId, name, userData, recognitionModel) {
            return new _Promise(function (resolve, reject) {
                request.put({
         ...
         * @return {Promise}                                - Promise resolving with the resulting JSON
         */
        get: function get(largePersonGroupId, options) {
            return new _Promise(function (resolve, reject) {
                request({
                    uri: host + rootPath + largePersonGroupPath + '/' + largePersonGroupId,
                    headers: { 'Ocp-Apim-Subscription-Key': key },
